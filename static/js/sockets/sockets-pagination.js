// ===== МОДУЛЬ ПАГИНАЦИИ СОКЕТОВ =====

window.SocketsPagination = (function() {
    ...
    function setupPaginationHandlers() {
        ...
        const savedLimit = localStorage.getItem('sockets_rows_per_page');
        if (savedLimit) {
        ...
        applyBtn.addEventListener('click', function() {
            ...
            if (newLimit >= 1 && newLimit <= 10000) {
                ...
                localStorage.setItem('sockets_rows_per_page', newLimit);
