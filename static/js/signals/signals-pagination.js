...
window.SignalsPagination = (function() {
    ...
    function setupPaginationHandlers() {
        ...
        // ОБЪЕДИНЕННЫЕ обработчики для кнопок пагинации (убрано дублирование)
        ...
        // ОБЪЕДИНЕННЫЕ обработчики для полей ввода страницы (убрано дублирование)
    ...
    function updatePaginationUI() {
        // ОБЪЕДИНЕНЫ элементы (убрано дублирование массивов)
        const elements = {
